...
namespace RabbitMQ_Sample.Controllers
{
    ...
    public class DirectController : ControllerBase
    {
        ...
        {
            var publishResult = _rabbitMqApi.Publish(new PublishRequest { Body = "Pdf_Events", RoutingKey = Key });
        ...
        {
            var subscribeResult = _rabbitMqApi.Subscribe(new SubscribeRequest { Queue = Key });
